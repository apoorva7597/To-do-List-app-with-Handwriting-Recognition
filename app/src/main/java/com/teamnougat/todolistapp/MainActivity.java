...
public class MainActivity extends AppCompatActivity implements OnGesturePerformedListener {
    ...
    public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture)
    {
        ...
        {
            if (prediction.score > 3.5 && prediction.name.toLowerCase().equals("personal")) {
                String selectQuery = "SELECT * FROM " + TaskContract.TaskEntry.TABLE
            ...
            else if (prediction.score > 3.5 && prediction.name.toLowerCase().equals("work")) {
                String selectQuery = "SELECT * FROM " + TaskContract.TaskEntry.TABLE
            ...
            else if (prediction.score > 3.5 && prediction.name.toLowerCase().equals("create")) {
