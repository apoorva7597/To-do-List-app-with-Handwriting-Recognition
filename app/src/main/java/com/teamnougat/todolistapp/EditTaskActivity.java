...
public class EditTaskActivity extends AppCompatActivity implements View.OnClickListener, OnGesturePerformedListener{
    ...
    public String findMonth( int tMonth ){
        String sMonth = "";
        if(tMonth == '1')
            sMonth = "Jan";
        else if (tMonth == '2')
            ...
            sMonth = "Sep";
        else if (tMonth == Integer.parseInt("10"))
            sMonth = "Oct";
        else if (tMonth == Integer.parseInt("11"))
            sMonth = "Nov";
        else
        {
            sMonth = "Dec";
    ...
    public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture)
    {
        ...
        {
            if (prediction.score > 4.0 && prediction.name.toLowerCase().equals("save")) {
            ...
            else if (prediction.score > 5.0 && prediction.name.toLowerCase().equals("previous"))
            {
                Intent i = new Intent(getApplicationContext(), ViewTaskActivity.class);
                i.putExtra("TASK_ID", task_id);
                startActivityForResult(i, 1);
